 ...
 * @return {Object} (ipAdrs) - an object with two propertiess: ipv4 and ipv6.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  let ipAdrs = {"ipv4":null,"ipv6":null};
  ...
  return callback(ipAdrs, callbackError);
}
